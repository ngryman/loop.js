 ...
 * @return {Manager}
 */
Manager.prototype.push = function(name, state, trans0, trans1) {
 ...
 * @return {Manager}
 */
Manager.prototype.change = function(name, callback) {
	var toexit = [],
		toenter = [],
		tochange = [],
		self = this,
 ...
 * @return {Manager}
 */
Manager.prototype.fire = function(event) {
 ...
 * @private
 */
Manager.prototype._pushEntry = function(name, parent, state, trans) {
 ...
 * @private
 */
Manager.prototype._enter = function(entry, cb) {
 ...
 * @private
 */
Manager.prototype._exit = function(entry, cb) {
	var cbw = function() {
		entry.active = false;
		entry.state.exit();
		cb();
